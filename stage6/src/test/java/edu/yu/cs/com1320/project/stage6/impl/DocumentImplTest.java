...
public class DocumentImplTest {
    ...
    void beforeDem() throws URISyntaxException{
        ...
        doc4WordCounts = new DocumentImpl(uri1, "and my name is And is Joe and hi and", null);
    ...
    void createNewDocTxt() throws URISyntaxException{
        ...
        assertThrows(IllegalArgumentException.class,  ()->{
            Document doc = new DocumentImpl(uri1, txts1, null);
        });
        URI uri = null;
        assertThrows(IllegalArgumentException.class,  ()->{
        ...
        URI uris1 = new URI("");
        assertThrows(IllegalArgumentException.class,  ()->{
            Document doc = new DocumentImpl(uris1, txt, null);
        });
        String txts2 = "";
        assertThrows(IllegalArgumentException.class,  ()->{
            Document doc = new DocumentImpl(uri1, txts2, null);
        });        
    }
    ...
    void getMetadata(){
        ...
        HashMap<String, String> myHm = doc1_b.getMetadata();
    ...
    @Test
    void nanoTimeTests(){
        assert(doc1_txt.getLastUseTime() < doc1_b.getLastUseTime());
        doc1_txt.setLastUseTime(System.nanoTime());
        assert(doc1_txt.getLastUseTime() > doc1_b.getLastUseTime());
    }

    //compareTo is obvious
